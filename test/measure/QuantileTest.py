...
class QuantileTest(unittest.TestCase):
    def test_min(self):
        ...
        self.assertLess(abs(kargs['fitness_q0.0'] - float(t.min(f))), 0.01)
    ...
    def test_max(self):
        ...
        self.assertLess(abs(kargs['fitness_q1.0'] - float(t.max(f))), 0.01)
    ...
    def test_95(self):
        ...
        self.assertLess(abs(kargs['fitness_q0.95'] - float(t.quantile(f, 0.95))), 0.01)
    ...
    def test_99(self):
        ...
        self.assertLess(abs(kargs['fitness_q0.99'] - float(t.quantile(f, 0.99))), 0.01)
    ...
    def test_34(self):
        ...
        self.assertLess(abs(kargs['fitness_q0.34'] - float(t.quantile(f, 0.34))), 0.01)
    ...
    def test_0_613(self):
        ...
        self.assertLess(abs(kargs['fitness_q0.613'] - float(t.quantile(f, 0.613))), 0.01)
